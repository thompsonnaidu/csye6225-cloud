...
assignmentRouter.get("/", async (req,res)=>{
    ...
    const assignmentList= await assignmentDb.findAll({attributes: { exclude: ['createdBy','updatedBy'] }});
...
assignmentRouter.get("/:id",async (req,res)=>{
    ...
    const assignmentInfo=await db.assignments.findOne({attributes: { exclude: ['createdBy','updatedBy'] },where:{id:assignmentId}});
